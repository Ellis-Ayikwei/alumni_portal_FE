import { faMoneyBillWave, faPen, faTrash } from '@fortawesome/free-solid-svg-icons';
...
const PaymentsMangement = () => {
    ...
    useEffect(() => {
        if (allPayments) {
            setInitialRecords(sortBy(allPayments, 'name'));
        }
    }, [allPayments]);
    ...
    const [initialRecords, setInitialRecords] = useState(sortBy(allPayments, 'name'));
    ...
    return (
        <div>
                ...
                <div className="datatables">
                    <DataTable
                        ...
                        columns={[
                            ...
                            { accessor: 'id', title: 'Payment Id', sortable: true, hidden: hideCols.includes('id') },
            ...
            {showModal && <MakePayments showModal={showModal} setShowModal={setShowModal} edit={edit} setEdit={setEdit} paymentId={paymentId} setPaymentId={setPaymentId} />}
