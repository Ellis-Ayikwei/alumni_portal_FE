    ...
    return (
        <div>
            <div className="flex items-center lg:justify-between  flex-wrap gap-4 mb-6">
                ...
                <Link to="/member/groups/edit" className="btn btn-warning gap-2">
                    <IconEdit />
                    Edit
                </Link>
            </div>
            <div className="panel">
                <div className="flex justify-between flex-wrap gap-4 px-4">
                    <div className="text-2xl font-semibold uppercase">Presec Legon Year 2014</div>
                ...
                <div className="grid xl:grid-cols-2 sm:grid-cols-1 gap-4">
                    ...
                    <div className="panel h-full w-full">
                        <div className="flex items-center justify-between mb-5">
                            <h5 className="font-semibold text-lg dark:text-white-light">Beneficiaries</h5>
                        </div>
                        <div className="table-responsive">
                            <table>
                                <thead>
...
export default MemberGroupPreview;
